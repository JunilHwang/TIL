...
즉, 기획/디자인/퍼블리싱/DB설계/개발 등 모든 일련의 과정을 단 18시간 안에 수행해야 하는 것이다. **그것도 인터넷 없이 하드코딩으로!**

> 대회를 처음 준비할 당시에는 어버버 했지만, 추후에 전국대회를 준비할 때 친구들과 10시간 이내로 모든 과정을 마무리 하는 것을 목표로 했고, 실제로 성공했다. ~~미친놈들~~
