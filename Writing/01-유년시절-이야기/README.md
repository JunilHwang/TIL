...
뭔가 되고 싶은 것도 없었고, 하고 싶은 것도 없었다. 공부는 싫어 했기 때문에 굳이 부모님에게 학원을 보내달라고 조르지도 않았다.

아 글을 쓰면서 생각난게 초등학교 1학년 때 컴퓨터 학원을 6개월 정도 다녔었다.
그냥 뜬금없이 아빠가 가서 타자연습이나 배워오라면서 다녔던 것 같다.

학원에서 타자연습을 익혔고, 어느 정도 속도가 나자 한글97로 워드프로세서 실기 연습을 했다.
초등학교 1학년 때 500타가 나왔다며 기뻐하던게 생각난다. 2학년 때는 1000타가 나와서 여기저기 자랑하고 다녔다.
그렇게 타자연습이 익숙해지자 한글 문서 만드는 법을 배웠고, 지금의 내가 생각해도 어린 나이에 기가막히게 잘 다뤘다.
실기 시험만 보면 항상 1등을 했는데 문제는 그 당시에 필기 시험이 뭔지도 몰랐고 뭘 공부해야 하는지도 몰라서 자격증 시험은 아예 재꼈다.
...
- 8시 이전에 학교에 도착하고,
  ...
  - 그래서 가능하면 1분이라도 빨리 버스를 타려고 뛰어다녔따.
...
아, 중학교 3학년 때 부터 입대하기 전 까지 약 6년 ~ 7년 정도 `버블파이터` 라는 게임을 했다.
웃기지만 나는 사회성을 `버블파이터`를 통해서 배웠다. 커뮤니티 활동도 꽤 열심히 했고, 게임 자체도 열심히 했다.
지금의 `오버워치`로 따지면 `경쟁전 랭킹 Top 10` 안에 들었었다.

워낙 한 게임을 오래 했고, 게임 시작만 하면 아는 사람을 만났고, 그러다 보니 자연스럽게 모든 말과 행동을 신경써야 했고, 게임에서 친해지면 실제로 만나는 경우도 많았다.
