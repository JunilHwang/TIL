...
진짜 대회를 하기 전까지는 PHP에서 DB의 내용을 어떻게 가져오는지도 몰랐는데 (그냥 외우기만 했다.)

내 손으로 직접 내가 원하는 데이터를 DB에서 뽑아내어 출력하는 것 까지 해낸 것이다.
입상은 하지 못했지만 그 과정이 정말 신기했다. 내가 한건 외운 것 밖에 없었는데 그게 어쩌다 보니 이해까지 되어버린 것이다. 

문제는 DB연결하는 법은 알았으나 Request, Response라는 개념도 제대로 몰랐고 GET, POST method도 뭐가 뭔지 몰랐다.
그렇게 첫 대회는 거하게 말아먹고, 그 뒤로는 암울한 생활이 이어졌다.
