...
어쩌다보니 면접도 보고, 면접 준비도 하면서 공부를 꽤 많이 했다.
그렇게 폭풍 같던 7월이 지나가고, 9월에 앞서 언급한 [블랙커피 스터디](#_2-블랙커피-스터디)를 참여하면서 **바닐라JS로 SPA 만드는 연습**을 했다.

그렇게 다시 9월에 진행하는 프론트엔드 개발 챌린지를 신청했다.
...
그렇게 경험을 목적으로 면접에 응시했고, 최종면접에서 떨어졌다. 사실 떨어질 수 밖에 없었다. 뚜렷한 이직 의사가 없었으니까.
...
그렇게 몇 개월의 시간이 흐른 후에, 포동이가 태어났고 이 당시만 해도 포동이를 모시게 될 것이라곤 상상하지 못했다.
